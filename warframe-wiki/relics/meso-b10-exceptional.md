...
name: Meso B10 Exceptional
rewards:
- chance: 2
  item:
    name: Boltor Prime Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T2VoidProjectionEmberRhinosVaultBBronze
    warframeMarket:
      id: 54a73e65e779893a797fff2f
      urlName: boltor_prime_blueprint
  rarity: Rare
- chance: 11
  item:
...
- chance: 11
  item:
    ...
    warframeMarket:
      ...
      urlName: sicarus_prime_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
    ...
    warframeMarket:
      ...
      urlName: ember_prime_chassis_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
