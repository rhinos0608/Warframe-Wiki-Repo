...
- chance: 2
  item:
    ...
    uniqueName: /Lotus/Types/Game/Projections/T1VoidProjectionLimboPrimeBBronze
    warframeMarket:
...
- chance: 11
  item:
    ...
    warframeMarket:
      ...
      urlName: ballistica_prime_upper_limb
  rarity: Uncommon
- chance: 11
  item:
...
- chance: 25.33
  item:
    ...
    warframeMarket:
      ...
      urlName: banshee_prime_neuroptics_blueprint
  rarity: Uncommon
source: WFCD
tags:
- Relic
