...
name: Meso T8 Exceptional
rewards:
- chance: 2
  item:
    name: Trumna Prime Barrel
    uniqueName: /Lotus/Types/Game/Projections/T2VoidProjectionYareliPrimeCBronze
    warframeMarket:
      id: 673516c7db3ac2cfade14a78
      urlName: trumna_prime_barrel
  rarity: Rare
- chance: 11
  item:
...
- chance: 11
  item:
    name: Akarius Prime Link
    uniqueName: /Lotus/Types/Game/Projections/T2VoidProjectionYareliPrimeCBronze
    warframeMarket:
      id: 65a7fca4ed5b0d2e3eb462cd
      urlName: akarius_prime_link
  rarity: Uncommon
- chance: 25.33
  item:
