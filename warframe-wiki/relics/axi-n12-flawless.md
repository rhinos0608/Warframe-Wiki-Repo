...
name: Axi N12 Flawless
rewards:
- chance: 2
  item:
    name: Nidus Prime Chassis Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T4VoidProjectionNidusSarynVaultABronze
    warframeMarket:
...
- chance: 25.33
  item:
    ...
    warframeMarket:
      ...
      urlName: nikana_prime_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
