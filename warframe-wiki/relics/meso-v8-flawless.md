...
name: Meso V8 Flawless
rewards:
- chance: 2
  item:
    name: Vauban Prime Neuroptics Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T2VoidProjectionAtlasVaubanVaultBBronze
    warframeMarket:
      id: 573b7fc80ec44a47787a690f
      urlName: vauban_prime_neuroptics_blueprint
  rarity: Rare
- chance: 11
  item:
