...
name: Lith T6 Exceptional
rewards:
- chance: 2
  item:
    name: Tiberon Prime Stock
    uniqueName: /Lotus/Types/Game/Projections/T1VoidProjectionChromaZephyrVaultBBronze
    warframeMarket:
      id: 5ab167b8b2b6a80475780fb8
      urlName: tiberon_prime_stock
  rarity: Rare
- chance: 11
  item:
