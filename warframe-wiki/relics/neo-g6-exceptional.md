...
name: Neo G6 Exceptional
rewards:
- chance: 2
  item:
    name: Glaive Prime Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T3VoidProjectionEmberRhinoVaultABronze
    warframeMarket:
...
- chance: 25.33
  item:
    ...
    warframeMarket:
      ...
      urlName: rhino_prime_systems_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
