...
name: Lith H10 Exceptional
rewards:
- chance: 2
  item:
    name: Harrow Prime Systems Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T1VoidProjectionHarrowNekrosVaultBBronze
    warframeMarket:
...
- chance: 11
  item:
    ...
    warframeMarket:
      ...
      urlName: nekros_prime_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
