...
- chance: 2
  item:
    ...
    uniqueName: /Lotus/Types/Game/Projections/T2VoidProjectionYBronze
    warframeMarket:
...
- chance: 11
  item:
    ...
    warframeMarket:
      ...
      urlName: rhino_prime_chassis_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
