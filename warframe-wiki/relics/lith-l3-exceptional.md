...
name: Lith L3 Exceptional
rewards:
- chance: 2
  item:
    name: Limbo Prime Chassis Blueprint
    uniqueName: /Lotus/Types/Game/Projections/T1VoidProjectionLimboTrinityVaultABronze
    warframeMarket:
...
- chance: 11
  item:
    ...
    warframeMarket:
      ...
      urlName: trinity_prime_chassis_blueprint
  rarity: Uncommon
- chance: 11
  item:
...
- chance: 25.33
  item:
    ...
    warframeMarket:
      ...
      urlName: dual_kamas_prime_blueprint
  rarity: Uncommon
- chance: 25.33
  item:
